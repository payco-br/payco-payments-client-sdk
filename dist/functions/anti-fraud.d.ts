 ...
 */
export declare function getVisitorID(): string | number;
/**
 ...
 */
export declare function setCustomerID(id: string | number): boolean;
/**
 ...
 * ```
 */
export declare function addPageTag(type: string, value: string): void;
